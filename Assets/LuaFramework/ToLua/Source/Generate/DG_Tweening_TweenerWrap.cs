...
public class DG_Tweening_TweenerWrap
{
	...
	static int From(IntPtr L)
	{
		try
		{
			...
			else if (count == 3)
			{
				...
				bool arg0 = LuaDLL.luaL_checkboolean(L, 2);
				bool arg1 = LuaDLL.luaL_checkboolean(L, 3);
				DG.Tweening.Tweener o = obj.From(arg0, arg1);
				ToLua.PushObject(L, o);
				return 1;
			}
			else
	...
	static int SetInverted(IntPtr L)
	{
		try
		{
			...
			{
				DG.Tweening.Tweener obj = (DG.Tweening.Tweener)ToLua.CheckObject<DG.Tweening.Tweener>(L, 1);
				DG.Tweening.Tween o = obj.SetInverted();
				ToLua.PushObject(L, o);
				return 1;
			}
			else if (count == 2)
			{
				DG.Tweening.Tweener obj = (DG.Tweening.Tweener)ToLua.CheckObject<DG.Tweening.Tweener>(L, 1);
				bool arg0 = LuaDLL.luaL_checkboolean(L, 2);
				DG.Tweening.Tween o = obj.SetInverted(arg0);
				ToLua.PushObject(L, o);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: DG.Tweening.Tweener.SetInverted");
			}
		}
		catch (Exception e)
		{
