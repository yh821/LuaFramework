...
public class Game_UINameTableWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Game.UINameTable), typeof(UnityEngine.MonoBehaviour));
	...
	static int Find(IntPtr L)
	{
		try
		{
			...
			Game.UINameTable obj = (Game.UINameTable)ToLua.CheckObject<Game.UINameTable>(L, 1);
	...
	static int Search(IntPtr L)
	{
		try
		{
			...
			Game.UINameTable obj = (Game.UINameTable)ToLua.CheckObject<Game.UINameTable>(L, 1);
			string arg0 = ToLua.CheckString(L, 2);
			Game.UINameTable.BindPair[] o = obj.Search(arg0);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int get_binds(IntPtr L)
	{
		...
		try
		{
			...
			Game.UINameTable obj = (Game.UINameTable)o;
			System.Collections.Generic.List<Game.UINameTable.BindPair> ret = obj.binds;
	...
	static int set_binds(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Game.UINameTable obj = (Game.UINameTable)o;
			System.Collections.Generic.List<Game.UINameTable.BindPair> arg0 = (System.Collections.Generic.List<Game.UINameTable.BindPair>)ToLua.CheckObject(L, 2, typeof(System.Collections.Generic.List<Game.UINameTable.BindPair>));
			obj.binds = arg0;
			return 0;
		}
		catch(Exception e)
